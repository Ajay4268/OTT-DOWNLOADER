...
def rip(url: str, quality: str = "720p", content_type: str = "movies", **kwargs):
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description=f"Rip from Mxplayer")
